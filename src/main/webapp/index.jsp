...
<body>
  ...
  <section class="container p-4">
    ...
    <p class="text-secondary">Etiam quis viverra lorem, in semper lorem. Sed nisl arcu euismod sit amet nisi euismod sed
      cursus arcu elementum ipsum arcu vivamus quis venenatis orci lorem ipsum et magna feugiat veroeros aliquam. Lorem
  ...
  <footer class="bg-dark p-5 text-center">
    ...
    <p>
      <a href="https://www.facebook.com/anmolvishw"><i class="fa-brands fa-facebook"></i></a>
      <a href="https://www.instagram.com/anmolvishw"><i class="fa-brands fa-instagram"></i></a>
      <a href="https://www.youtube.com/anmolvishw"><i class="fa-brands fa-youtube"></i></a>
    </p>
  </footer>
